...
if __name__ == "__main__":
    ...
    if conn:
        ...
        add_product(conn, "Widget", 100.50)
        add_product(conn, "Gadget ", 672.00)
        add_product(conn, "Thing ", 10.55)
        add_product(conn, "car ", 20.50) # Same price as A
        add_product(conn, "bike ", 23.00) # Same price as B
        add_product(conn, "Item ", 5.22)
